...
else
{
	...
	$mysql = "INSERT INTO telefon_pintar 
			  (no_siri, kod_jenama, harga, kuantiti, penerangan, gambar, id_admin)
			  VALUES
			  ('$nosiri', '$jenama', '$harga', '$kuantiti', '$penerangan', '$gambar', '$id')";

	if (mysqli_query($conn, $mysql)) {
	//papar js popup mesej jika maklumat produk berjaya disimpan
	echo '<script>alert("Telefon pintar baharu berjaya DISIMPAN!");
